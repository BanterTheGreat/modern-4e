...
#let creationAndAdvancementPage() = {
  ...
  A character can be created in 6 simple steps:
    ...
    [6th], [—], [gain 1 utility power; gain 1 feat; gain 1 technique], [4], [3], [2/2/3/2],
    ...
    [11th], [—], [#block("paragon path features; gain 1 paragon path encounter attack power; gain 1 feat", breakable: false)], [7], [5], [2/4/3/3],
    ...
    [16th], [+1 to all], [paragon path feature; gain 1 feat; gain 1 technique], [10], [8], [2/4/4/5],
    ...
    [21st], [—], [epic destiny feature; gain 1 feat], [13], [10], [2/4/4/5],
    ...
    [26th], [—], [gain 1 epic destiny utility power; gain 1 feat; gain 1 technique], [15], [13], [2/4/4/6],
